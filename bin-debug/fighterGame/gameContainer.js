...
(function (fighterGame) {
    var gameContainer = (function (_super) {
        ...
        function gameContainer() {
            ...
            _this.playerBullets = [];
            _this.enemyFighters = [];
            _this.enemyFightersTimer = new egret.Timer(800);
            _this.specialItemTimer = new egret.Timer(8000);
            _this.enemyBullets = [];
            _this.specialItems = [];
            _this.myScore = 0;
            _this.particleState = 0;
        ...
        gameContainer.prototype.preCreatedInstance = function () {
            ...
            for (i = 0; i < 20; i++) {
                var enemyFighter = fighterGame.fighter.produce("bug_png", (400 + Number(this.myScore < 1000) * 200 + 200 * Math.random()), (1 + Number(Math.random() > (1000 / (this.myScore + 1)))));
        ...
        gameContainer.prototype.createBulletHandler = function (evt) {
            ...
            if (evt.target == this.playerFighter) {
                for (var i = 0; i < this.playerFighter.bulletNumber; i++) {
                ...
                if (theFighter.bulletNumber == 1) {
                    ...
                    for (var i = 0; i < theFighter.bulletNumber; i++) {
                        bullet = fighterGame.bullet.produce("bug_bullet_png");
        ...
        gameContainer.prototype.createEnemyFighter = function (evt) {
            var enemyFighter = fighterGame.fighter.produce("bug_png", (300 + Number(this.myScore < 1000) * 500 + 500 * Math.random()), (1 + Number(Math.random() > (1000 / (this.myScore + 1)))));
        ...
        gameContainer.prototype.createSpecialItem = function (evt) {
            var r = Math.random();
            var specialItem;
            if (r <= 0.05) {
        ...
        gameContainer.prototype.gameViewUpdate = function (evt) {
            ...
            var i = 0;
            var bullet;
            var playerBulletsCount = this.playerBullets.length;
            ...
            var specialItemCount = this.specialItems.length;
            var specialItem;
        ...
        gameContainer.prototype.gameHitTest = function () {
            ...
            for (i = 0; i < enemyBulletsCount; i++) {
                ...
                if (fighterGame.GameUtils.hitTest(this.playerFighter, bullet)) {
                    var dmg = 1 + (Math.random() > 0.5 ? 1 : 0) + 2 * Number(this.myScore >= 1000);
        ...
        gameContainer.prototype.shareHandler = function () {
    ...
    fighterGame.gameContainer = gameContainer;
    __reflect(gameContainer.prototype, "fighterGame.gameContainer");
